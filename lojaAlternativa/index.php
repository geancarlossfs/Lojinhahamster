...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="#"><img src="assets/imagens/511881508499448.png" alt="" width="120px"></a>
...
<header class="jumbotron my-4 home-banner">
    <div class="container">
        <h1 class="display-3">Hamsters do IFC</h1>
        <p class="lead">Seja bem vindo a nossa loja querida e amada por todos, aproveite cada um de nossos produtos e boas compras!!</p>
    ...
    <div class="row text-center">
        ...
        <?php foreach($listaProdutos as $prod): ?>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card">
                    <img class="card-img-top" src="assets/imagens/Hamster.jpg" alt="">
                    <div class="card-body">
                        <h4 class="card-title"><?= $prod->nome ?></h4>
                        <p class="card-text"><?= $prod->preco ?></p>
                        <p id="disponivel" class="card-text"><?= $prod->getDisponibilidade() ?></p>
                        <p class="card-text">Compre já o seu hamster e divirta-se com ele, aproveite bastante a fofura do bicho</p>
                    </div>
