...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="../../index.php"><img src="../../assets/imagens/511881508499448.png" alt="" width="80px"></a>
        ...
        <div class="col-md-7">
            ...
            <div class="row add-to-cart">
                <div class="col-md-5 product-qty">
                    <form action="../controllers/controladorProduto.php" method="post"></form>
